        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    class="text-indigo-600 rounded shadow-sm dark:bg-zinc-900 border-zinc-300 dark:border-zinc-700 focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-zinc-800"
                    name="remember">
